...
'Step 11 : get Expected from Pay Request Screen'
...
String PRGLAccNo=''
PRGLAccNo=hmPayRequestDetails.get('GLAccNo')
String PRHIICCID=''
PRHIICCID=hmPayRequestDetails.get('HIICCID')
...
'Step 12 : get expected from Contract Screen'
...
String CGLAccNo=''
CGLAccNo=hmContractDetails.get('GLAccNo')
String CHIICCID=''
CHIICCID=hmContractDetails.get('HIICCID')
...
'Step 13 : Get Expected from GL Account Maintenance By PE'		
