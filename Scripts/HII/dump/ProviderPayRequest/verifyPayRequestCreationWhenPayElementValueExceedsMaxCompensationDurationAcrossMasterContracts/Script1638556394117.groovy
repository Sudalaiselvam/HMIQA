...
for (int i = 1; i <= ProviderPayRequest.getRowNumbers(); i++) {
	...
	ProviderPayRequestSteps.savePayRequest_ContinueExceedingMaxCompensation_AcrossMasterContracts(ProviderPayRequest.getValue('RequestDate', i),ProviderPayRequest.getValue('PayElementValue',i), ContractMaxCompensation)
