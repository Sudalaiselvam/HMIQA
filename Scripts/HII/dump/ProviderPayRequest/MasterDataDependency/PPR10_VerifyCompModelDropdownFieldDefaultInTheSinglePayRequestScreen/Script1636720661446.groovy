...
ArrayList<String> expectedCompensationModels = new ArrayList<String>()
...
ProviderPayRequestSteps.verifyDefaultCompensationModel(expectedCompensationModels.get(expectedCompensationModels.size()-1))