...
for (int i = 1; i <= ProviderPayRequest.getRowNumbers(); i++) {
	...
	ProviderPayRequestSteps.savePayRequest_CancelExceedingMaxCompensation_WithintheContract(ProviderPayRequest.getValue('RequestDate', i), ProviderPayRequest.getValue('CompensationModel', i), ProviderPayRequest.getValue('PayElementValue',i), ContractMaxCompensation)
